#' Calculate a vector of the force of infection into each group, from a vector
#' (of length n_groups) giving the number of new infections on a given day.
#'
#' @title Calculate FI oOver Groups
